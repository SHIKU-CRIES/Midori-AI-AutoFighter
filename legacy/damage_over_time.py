...
class dot:
    ...
    """
    def __init__(self, name: str, damage: float, turns: int, damage_type: DamageType = Generic, source: str | None = None, tick_interval: int = 1, metadata: dict[str, Any] | None = None) -> None:
