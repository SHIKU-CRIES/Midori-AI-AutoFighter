<script>
  ...
  import ModernFighterCard from '../battle/ModernFighterCard.svelte';
    ...
    <div class="foe-row">
      {#each foes as foe (foe.id)}
        <div class="foe-container">
          ...
          <ModernFighterCard fighter={foe} position="top" {reducedMotion} />
            ...
            <div class="summon-list">
              {#each foe.summons as summon (summon.id)}
                <div
                  ...
                  class="summon-entry"
                >
                  <ModernFighterCard fighter={summon} position="top" {reducedMotion} size="small" />
                </div>
              {/each}
            </div>
          {/if}
    ...
    {#each party as member (member.id)}
      <div class="party-container">
        <div class="party-main">
          ...
          <ModernFighterCard fighter={member} position="bottom" {reducedMotion} />
          ...
          <div class="summon-list">
            {#each member.summons as summon (summon.id)}
              <div
                ...
                class="summon-entry"
              >
                <ModernFighterCard fighter={summon} position="bottom" {reducedMotion} size="small" />
              </div>
            {/each}
          </div>
        {/if}
