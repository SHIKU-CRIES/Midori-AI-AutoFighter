...
import asyncio
import time
from autofighter.effects import EffectManager, DamageOverTime
...
async def test_many_dots_performance():
    ...
    print(f"With 1 character having 800 DOTs:")
    ...
    print(f"With multiple characters each having 800 DOTs:")
