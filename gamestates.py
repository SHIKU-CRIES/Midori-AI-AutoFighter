...
def main(level):
    ...
    while True:
        ...
        while running:
            ...
            player_base_enrage_mod = (enrage_mod * (level_base_enrage_mod * player.Vitality * (player.DodgeOdds / 100)))
            foe_base_enrage_mod = (enrage_mod * (level_base_enrage_mod * foe.Vitality * (foe.DodgeOdds / 100)))
