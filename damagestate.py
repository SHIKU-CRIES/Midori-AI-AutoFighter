...
def apply_damage_item_effects(source: Player, target: Player, mited_damage_dealt: float):
        ...
        for item in source.Items:
            ...
            try:
                ...
                log(white, f"Item effect from {source.PlayerName}: {item.name}, Damage Diff: {mited_damage_dealt - before_damage}")
        ...
        for item in target.Items:
            ...
            try:
                ...
                log(white, f"Item effect from {target.PlayerName}: {item.name}, Damage Diff: {mited_damage_dealt - before_damage}")
            except Exception as error:
                continue
