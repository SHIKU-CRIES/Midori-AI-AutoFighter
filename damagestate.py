            ...
            if source.isplayer == player.isplayer:
                if player.PlayerName is not source.PlayerName:
                    if player.HP > player.MHP * 0.25:
                        ...
                        player.gain_damage_over_time(damageovertimetype("Abyssal Weakness", source.above_threshold_ticks ** 1.05, round(55 * source.above_threshold_ticks), source.Type, source.PlayerName, 1), 0.95)
